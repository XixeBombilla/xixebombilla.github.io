...
const Badge = ({ label, className = "", link = "" }: BadgeProps) => {
  const badgeStyle = `bg-electric-faded text-electric uppercase rounded-full flex items-center px-6 lg:px-3 py-4 lg:py-1 text-4xl lg:text-[12px] font-bold inline-block mr-5 lg:mr-2 mb-8 lg:mb-4 ${className} ${
    link ? "hover:bg-electric hover:text-black" : ""
  }`;
