...
const Badge = ({ label, className = "", link = "" }: BadgeProps) => {
  const badgeStyle = `bg-electric dark:bg-electric-faded dark:text-electric text-current uppercase rounded-full flex items-center px-4 lg:px-3 py-2 lg:py-1 text-[12px] font-bold inline-block mr-2 lg:mr-2 mb-4 ${className} ${
    link
